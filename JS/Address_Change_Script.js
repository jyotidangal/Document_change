...
document.getElementById("r_meeting_date4").innerText = convertedDate;
    ...
    document.querySelectorAll("[id^='r_current_address']").forEach(el => el.innerText = document.getElementById("current_address").value);
    document.querySelectorAll("[id^='r_new_address']").forEach(el => el.innerText = document.getElementById("new_address").value);
